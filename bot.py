...
# ================== EMOJIS CUSTOMIZADOS ==================
# Atenção: os nomes/IDs abaixo apontam para emojis customizados já existentes
# no servidor Discord (ex.: "hanaaura"). Renomear aqui NÃO renomeia o emoji
# em si — se quiser trocar o nome, é preciso recriar/renomear o emoji custom
# no servidor e atualizar o ID correspondente.
EMOJIS = {
